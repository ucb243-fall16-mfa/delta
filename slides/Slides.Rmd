...
- After the weights have been collected, they are used to compute the GSVD
  under the contraints provided by M (masses for the observations) and A (squared
...
- In MFA, the importance of a dimension is reflected by its eigenvalue which indicates
  how much of the total inertia of the data is exmplained by that component
...
- ContribObs, ContribVar, and ContribTable functions are used to computer the 
